...
template<class T> class Lista {
    ...
    public:
         ...
         * 		iniciarCursor() y desde entonces no se han agregado o
         * 		removido elementos de la Lista.
         * post: mueve el cursor y lo posiciona en el anterior elemento
         * 		del recorrido.
         * 		El valor de retorno idica si el cursor quedo posicionado
         * 		sobre un elemento o no (en caso de que la Lista este vacia o
         * 		no existan mas elecmentos por recorrer.)
         */
        bool atrasarCursor();
